...
<div class="bg-white p-6 rounded shadow md:w-1/2">
    <form action="{{ route('produk.update', $produk->id_produk) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="kode_produk" value="{{ old('kode_produk', $produk->kode_produk) }}" class="border rounded w-full py-2 px-3 text-gray-700 bg-gray-50 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600" required>
        </div>

        <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2">Nama Produk</label>
            <input type="text" name="nama_produk" value="{{ old('nama_produk', $produk->nama_produk) }}" class="border rounded w-full py-2 px-3 text-gray-700 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="harga" value="{{ (int)old('harga', $produk->harga) }}" class="border rounded w-full py-2 px-3 text-gray-700 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600" min="0" required>
        </div>
