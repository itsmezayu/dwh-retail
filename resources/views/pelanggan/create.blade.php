...
<div class="bg-white p-6 rounded shadow md:w-1/2">
    <form action="{{ route('pelanggan.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="kode_pelanggan" value="{{ old('kode_pelanggan') }}" class="border rounded w-full py-2 px-3 text-gray-700 bg-gray-50 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600" required>
        </div>

        <div class="mb-4">
            <label class="block text-gray-700 font-bold mb-2">Nama Pelanggan</label>
            <input type="text" name="nama_pelanggan" value="{{ old('nama_pelanggan') }}" class="border rounded w-full py-2 px-3 text-gray-700 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="kota" value="{{ old('kota') }}" class="border rounded w-full py-2 px-3 text-gray-700 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600" required>
        </div>
