...
<div class="bg-white p-5 rounded shadow">
    <form action="{{ route('pelanggan.update', $pelanggan->id_pelanggan) }}" method="POST">
        ...
        <div class="mb-5">
            ...
            <input type="text" name="kode_pelanggan" value="{{ old('kode_pelanggan', $pelanggan->kode_pelanggan) }}" class="border rounded w-full py-2 px-3 text-black bg-gray-50 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600" required>
        </div>

        <div class="mb-5">
            <label class="block text-black font-bold mb-2">Nama Pelanggan</label>
            <input type="text" name="nama_pelanggan" value="{{ old('nama_pelanggan', $pelanggan->nama_pelanggan) }}" class="border rounded w-full py-2 px-3 text-black border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600" required>
        </div>
        ...
        <div class="mb-5">
            ...
            <input type="text" name="kota" value="{{ old('kota', $pelanggan->kota) }}" class="border rounded w-full py-2 px-3 text-black border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600" required>
        </div>
