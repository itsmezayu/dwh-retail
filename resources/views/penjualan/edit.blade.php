...
<div class="bg-white p-6 rounded shadow mb-6 w-full md:w-2/3">
    <form action="{{ route('penjualan.update', $penjualan->id_penjualan) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="jumlah" id="jumlah" value="{{ old('jumlah', $penjualan->jumlah) }}" class="border rounded w-full py-2 px-3 text-gray-700 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600" min="1" required oninput="calculateTotal()">
            </div>
        ...
        <div class="mt-6 flex space-x-2">
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded font-bold hover:bg-blue-700">Perbarui Transaksi</button>
            <a href="{{ route('penjualan.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded font-bold hover:bg-gray-600">Batal</a>
        </div>
    </form>
</div>
